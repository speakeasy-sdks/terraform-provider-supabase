...
export type UpdatePostgresConfigBodySessionReplicationRole = ClosedEnum<
  typeof UpdatePostgresConfigBodySessionReplicationRole
>;
...
export type UpdatePostgresConfigBody = {
  ...
  restartDatabase?: boolean | undefined;
...
/** @internal */
export const UpdatePostgresConfigBodySessionReplicationRole$inboundSchema:
  z.ZodNativeEnum<typeof UpdatePostgresConfigBodySessionReplicationRole> = z
    .nativeEnum(UpdatePostgresConfigBodySessionReplicationRole);

/** @internal */
export const UpdatePostgresConfigBodySessionReplicationRole$outboundSchema:
  z.ZodNativeEnum<typeof UpdatePostgresConfigBodySessionReplicationRole> =
    UpdatePostgresConfigBodySessionReplicationRole$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace UpdatePostgresConfigBodySessionReplicationRole$ {
  /** @deprecated use `UpdatePostgresConfigBodySessionReplicationRole$inboundSchema` instead. */
  export const inboundSchema =
    UpdatePostgresConfigBodySessionReplicationRole$inboundSchema;
  /** @deprecated use `UpdatePostgresConfigBodySessionReplicationRole$outboundSchema` instead. */
  export const outboundSchema =
    UpdatePostgresConfigBodySessionReplicationRole$outboundSchema;
}

/** @internal */
export const UpdatePostgresConfigBody$inboundSchema: z.ZodType<
...
> = z.object({
  ...
  session_replication_role:
    UpdatePostgresConfigBodySessionReplicationRole$inboundSchema.optional(),
}).transform((v) => {
  return remap$(v, {
    ...
    "work_mem": "workMem",
    "restart_database": "restartDatabase",
    "session_replication_role": "sessionReplicationRole",
  });
});

/** @internal */
export type UpdatePostgresConfigBody$Outbound = {
  ...
  restart_database?: boolean | undefined;
  session_replication_role?: string | undefined;
};

/** @internal */
export const UpdatePostgresConfigBody$outboundSchema: z.ZodType<
  UpdatePostgresConfigBody$Outbound,
  z.ZodTypeDef,
  UpdatePostgresConfigBody
> = z.object({
  ...
  restartDatabase: z.boolean().optional(),
  sessionReplicationRole:
    UpdatePostgresConfigBodySessionReplicationRole$outboundSchema.optional(),
}).transform((v) => {
  return remap$(v, {
    ...
    workMem: "work_mem",
    restartDatabase: "restart_database",
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace UpdatePostgresConfigBody$ {
  /** @deprecated use `UpdatePostgresConfigBody$inboundSchema` instead. */
  export const inboundSchema = UpdatePostgresConfigBody$inboundSchema;
  /** @deprecated use `UpdatePostgresConfigBody$outboundSchema` instead. */
  export const outboundSchema = UpdatePostgresConfigBody$outboundSchema;
  /** @deprecated use `UpdatePostgresConfigBody$Outbound` instead. */
  export type Outbound = UpdatePostgresConfigBody$Outbound;
}

export function updatePostgresConfigBodyToJSON(
  updatePostgresConfigBody: UpdatePostgresConfigBody,
): string {
  return JSON.stringify(
    UpdatePostgresConfigBody$outboundSchema.parse(updatePostgresConfigBody),
  );
}

export function updatePostgresConfigBodyFromJSON(
  jsonString: string,
): SafeParseResult<UpdatePostgresConfigBody, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UpdatePostgresConfigBody$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UpdatePostgresConfigBody' from JSON`,
  );
}
