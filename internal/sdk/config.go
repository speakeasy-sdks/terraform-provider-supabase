...
func (s *config) GetPostgresConfig(ctx context.Context, request operations.GetPostgresConfigRequest, opts ...operations.Option) (*operations.GetPostgresConfigResponse, error) {
...
func (s *config) UpdatePostgresConfig(ctx context.Context, request operations.UpdatePostgresConfigRequest, opts ...operations.Option) (*operations.UpdatePostgresConfigResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
	}
