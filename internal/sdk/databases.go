...
func (s *Databases) GetTypescriptTypes(ctx context.Context, request operations.V1GenerateTypescriptTypesRequest, opts ...operations.Option) (*operations.V1GenerateTypescriptTypesResponse, error) {
