...
// InitializeHostnameConfig - [Beta] Updates project's custom hostname configuration
func (s *Domains) InitializeHostnameConfig(ctx context.Context, request operations.V1UpdateHostnameConfigRequest, opts ...operations.Option) (*operations.V1UpdateHostnameConfigResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// DeleteVanitySubdomain - [Beta] Deletes a project's vanity subdomain configuration
func (s *Domains) DeleteVanitySubdomain(ctx context.Context, request operations.V1DeactivateVanitySubdomainConfigRequest, opts ...operations.Option) (*operations.V1DeactivateVanitySubdomainConfigResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
