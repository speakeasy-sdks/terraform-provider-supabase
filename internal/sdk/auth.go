...
// UpdateAuthConfig - Updates a project's auth config
func (s *Auth) UpdateAuthConfig(ctx context.Context, request operations.V1UpdateAuthServiceConfigRequest, opts ...operations.Option) (*operations.V1UpdateAuthServiceConfigResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// ListThirdPartyAuth - [Alpha] Lists all third-party auth integrations
func (s *Auth) ListThirdPartyAuth(ctx context.Context, request operations.ListTPAForProjectRequest, opts ...operations.Option) (*operations.ListTPAForProjectResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// DeleteThirdPartyAuth - [Alpha] Removes a third-party auth integration
func (s *Auth) DeleteThirdPartyAuth(ctx context.Context, request operations.DeleteTPAForProjectRequest, opts ...operations.Option) (*operations.DeleteTPAForProjectResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// GetThirdPartyAuth - [Alpha] Get a third-party integration
func (s *Auth) GetThirdPartyAuth(ctx context.Context, request operations.GetTPAForProjectRequest, opts ...operations.Option) (*operations.GetTPAForProjectResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
